  ...
  return (
    <FrameShell id="product" className="w-full p-0">
      <section ref={containerRef} className="bg-[var(--paper)]">
        <div className="overview-intro flex items-center px-6 sm:px-8 lg:px-10">
        ...
        <section className="overview-visual relative overflow-hidden border-t-2 border-black/7">
          <Image
            ...
            fill
            sizes="(min-width: 1170px) 1167px, 100vw"
